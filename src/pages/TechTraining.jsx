...
import '../styles/TechTraining.css';
...
export default function TechTraining() {
  return (
    <div className="Tech min-h-screen bg-white my-40 cursor-default">
      <div className="container mx-auto px-4 py-12 md:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="space-y-4 animate-fade-in">
            {instructors.map((instructor, index) => (
              <div
                key={instructor.name}
                className="Tech-sir bg-primary p-6 flex items-center gap-6 transform transition-all duration-500 hover:translate-x-2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {categories.map((category, index) => (
            ...
            >
              <div className={`Tech-sir w-12 h-12 rounded-[4px] flex items-center justify-center mb-4 ${category.bgColor}`}>
                {category.icon}
              </div>
